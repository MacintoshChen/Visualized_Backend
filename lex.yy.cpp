...
char G_sBuff[200][200];   /* �洢�������  */
int G_iBuffRowCount = 0;       /*��ǰ������� */
int G_iBuffColCount = 0;       /* ��ǰ������� */

void add_buff(char*); /*���ڴ���������� */
void yyerror(char*);
#line 391 "lex.yy.c"
